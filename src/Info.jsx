const Info = () => {
  return (
    <div className="bg-[url('/lock-share-logo.png')] sm-">
      <div className="mx-auto container py-18">
        <div className="mx-2 py-4">
          <h3>
            We are a group of crypto enthusiasts who believe in the power of
            decentralization and the potential of blockchain technology. Our
            mission is to spread awareness about cryptocurrencies and help
            people navigate the complex world of crypto.
          </h3>
          <div className="flex justify-items-center gap-3 pt-3">
            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
              <div className="h-full p-4 lg:w-1/3">
                <div className=" bg-gray-100 px-8 pt-16 pb-16 relative">
                  <h2 className="text-xs mb-1">PHASE 1</h2>
                  <h1 className="title-font sm:text-2xl text-xl  mb-3">
                    Raclette Blueberry Nextious
                  </h1>
                  <ul>
                    <li>Website Creation</li>
                    <li>Contract Creation and Launch</li>
                  </ul>
                </div>
              </div>
              <div className="h-full p-4 lg:w-1/3">
                <div className="bg-gray-100 px-8 pt-16 pb-16 relative">
                  <h2 className="text-xs mb-1">PHASE 2</h2>
                  <h1 className="title-font sm:text-2xl text-xl  mb-3">
              ...
              <div className="h-full p-4 lg:w-1/3">
                <div className="bg-gray-100 px-8 pt-16 pb-16 relative">
                  <h2 className="text-xs mb-1">PHASE 3</h2>
                  <h1 className="title-font sm:text-2xl text-xl mb-3">
          ...
          <div className="mt-2">
            <h2 className="mb-1">Development</h2>
            <div>
